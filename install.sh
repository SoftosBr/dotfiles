...
packages="${packages_i3} ${packages_amd_driver} ${packages_sound_system} ${packages_arch}"
...
stow -d .. -t "$HOME" dotfiles --override='.*' --ignore='install.sh|root'
